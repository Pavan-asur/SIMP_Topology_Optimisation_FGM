...
% 负责更新结构模型的设计变量扩展系数
%
% 返回更新后的设计变量扩展系数coeffnew,维度(nely+1)*(nelx+1)-by-1;
% 
%
% Copyright @ 华中科技大学  高杰 in 2015/10/15
% Version 1.0
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% start sub-function "GCMMA.m" including a dual solver
function [xmma,ymma,zmma,lam,xsi,eta,mu,zet,s,low,upp] = GCMMA(m,n,iter,xval,xmin,xmax,xold1,xold2, ...
f0val,df0dx,df0dx2,fval,dfdx,dfdx2,low,upp,a0,a,c,d)

%    This function GCMMA performs one MMA-iteration, aimed at
...
%  iter  = Current iteration number ( =1 the first time GCMMA is called).
...
%%% (4.1.2): Solving the convex sub-problems by a primal-dual Newton method
[xmma,ymma,zmma,lam,xsi,eta,mu,zet,s] = MMASubOpmizer(m,n,epsimin,low,upp,alfa,beta,p0,q0,P,Q,a0,a,b,c,d);
% End sub-function "GCMMA.m" including a dual solver